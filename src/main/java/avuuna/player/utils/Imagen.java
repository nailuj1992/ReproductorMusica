...
public class Imagen implements Serializable {
	...
	public static final String BTN_PAUSE = "Pause48.png";
	public static final String BTN_PLAY = "Play48.png";
	public static final String BTN_CLOSE = "Close48.png";
	public static final String BTN_PREV = "Skip-backward48.png";
	public static final String BTN_NEXT = "Skip-forward48.png";
	public static final String BTN_STOP = "Stop48.png";
